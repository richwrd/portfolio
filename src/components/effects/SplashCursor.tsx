...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getThemeColor(variable: string): ColorRGB {
    ...
    function generateColor(): ColorRGB {
      // Alterna aleatoriamente entre primary e secondary
      const isPrimary = Math.random() > 0.5;
      const color = getThemeColor(isPrimary ? '--primary' : '--secondary');

      // Intensidade ultraminimalista (10% da cor original)
      const intensity = 0.1;
