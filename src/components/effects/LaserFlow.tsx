...
export const LaserFlow: React.FC<Props> = ({
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uVLenFactor: { value: trailLength ?? verticalSizing },
      ...
      uDirection: { value: direction === 'down' ? -1.0 : 1.0 }
    };
  ...
  useEffect(() => {
    ...
    uniforms.uVLenFactor.value = trailLength ?? verticalSizing;
    uniforms.uDirection.value = direction === 'down' ? -1.0 : 1.0;
